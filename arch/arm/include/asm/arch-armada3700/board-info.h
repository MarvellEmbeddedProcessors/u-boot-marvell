...
#define ARMAMA3700_DDR3_DB_V2		(ARMAMA3700_MARVELL_BOARD_ID_BASE + 2)
#define ARMAMA3700_DDR4_DB_V2		(ARMAMA3700_MARVELL_BOARD_ID_BASE + 3)
#define ARMAMA3700_MARVELL_MAX_BOARD_ID	(ARMAMA3700_MARVELL_BOARD_ID_BASE + 4)
...
#define MV_DEFAULT_BOARD_ID		ARMAMA3700_DDR3_DB_V2
...
#define DEFAULT_DDR3_V2_FDT_CONFIG_ID	A3700_DDR3_DB_V2_CONFIG_ID_USB3
#define DEFAULT_DDR4_V2_FDT_CONFIG_ID	A3700_DDR4_DB_V2_CONFIG_ID_USB3
...
#define DEFAULT_FDT_PER_BOARD { \
	...
	DEFAULT_DDR3_V2_FDT_CONFIG_ID,	/* default fdt_config_id for armada-3700-ddr3-db v2 board */	\
	DEFAULT_DDR4_V2_FDT_CONFIG_ID,	/* default fdt_config_id for armada-3700-ddr4-db v2 board */	\
}
