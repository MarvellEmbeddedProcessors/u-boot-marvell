...
/* For CP-110 we have 2 Selector registers "PHY Selectors", and " PIPE
   ...
   for example: serdes lane2 had option Eth_port_0 that include (SGMII0, XAUI0, RXAUI0, SFI) */
struct comphy_mux_data cp110_comphy_phy_mux_data[] = {
/* Lane 0 */ {4, {{PHY_TYPE_UNCONNECTED, 0x0}, {PHY_TYPE_SGMII1, 0x1}, {PHY_TYPE_SATA1, 0x4} } },
/* Lane 1 */ {4, {{PHY_TYPE_UNCONNECTED, 0x0}, {PHY_TYPE_SGMII2, 0x1}, {PHY_TYPE_SATA0, 0x4} } },
/* Lane 2 */ {6, {{PHY_TYPE_UNCONNECTED, 0x0}, {PHY_TYPE_SGMII0, 0x1}, {PHY_TYPE_RXAUI0, 0x1},
			{PHY_TYPE_SFI, 0x1}, {PHY_TYPE_SATA0, 0x4} } },
/* Lane 3 */ {8, {{PHY_TYPE_UNCONNECTED, 0x0}, {PHY_TYPE_RXAUI1, 0x1}, {PHY_TYPE_SGMII1, 0x2},
			{PHY_TYPE_SATA1, 0x4} } },
/* Lane 4 */ {7, {{PHY_TYPE_UNCONNECTED, 0x0}, {PHY_TYPE_SGMII2, 0x1}, {PHY_TYPE_RXAUI0, 0x2},
			{PHY_TYPE_SFI, 0x2}, {PHY_TYPE_SGMII1, 0x2} } },
/* Lane 5 */ {6, {{PHY_TYPE_UNCONNECTED, 0x0}, {PHY_TYPE_SGMII2, 0x1}, {PHY_TYPE_RXAUI1, 0x2},
			{PHY_TYPE_SATA1, 0x4} } },
};
...
static int comphy_sfi_power_up(u32 lane, void __iomem *hpipe_base, void __iomem *comphy_base)
{
	u32 mask, data, ret = 1;
	void __iomem *hpipe_addr = HPIPE_ADDR(hpipe_base, lane);
	void __iomem *sd_ip_addr = SD_ADDR(hpipe_base, lane);
...
static void comphy_utmi_phy_init(u32 utmi_phy_count, struct utmi_phy_data *cp110_utmi_data)
{
	...
	for (i = 0; i < utmi_phy_count; i++) {
		...
		if (cp110_utmi_data[i].utmi_phy_port == UTMI_PHY_TO_USB3_DEVICE0)
			printf("USB Device\n");
		else
...
int comphy_cp110_init(struct chip_serdes_phy_config *ptr_chip_cfg, struct comphy_map *serdes_map)
{
	...
	for (lane = 0, ptr_comphy_map = serdes_map; lane < comphy_max_count; lane++, ptr_comphy_map++) {
		...
		case PHY_TYPE_SGMII3:
			...
			break;
		case PHY_TYPE_SFI:
			ret = comphy_sfi_power_up(lane, hpipe_base_addr, comphy_base_addr);
			break;
