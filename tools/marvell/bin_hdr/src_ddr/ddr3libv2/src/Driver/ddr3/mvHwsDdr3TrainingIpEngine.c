...
/* num tx phases  tx burst   delay between   rx pattern start_address   patternLen*/
   ...
   {0x1, 	0x1,	2,  0x1, 0x0020,  2  }, /* PATTERN_PBS2*/
   {0x1, 	0x1,	2,  0x1, 0x0040,  2  }, /* PATTERN_PBS3*/
   {0x1, 	0x1,	2,  0x1, 0x0060,  2  }, /* PATTERN_TEST*/
   {0x1, 	0x1,	2,  0x1, 0x0080,  2  }, /* PATTERN_RL*/
   {0x1, 	0x1,	2,  0x1, 0x00a0,  2  }, /* PATTERN_RL2*/
   {0xf,  	0x7,    2,	0x7, 0x00c0, 16  }, /* PATTERN_STATIC_PBS*/
   {0xf,  	0x7,    2,	0x7, 0x00e0, 16  }, /* PATTERN_KILLER_DQ0*/
   {0xf,  	0x7,    2,	0x7, 0x0100, 16  }, /* PATTERN_KILLER_DQ1*/
   {0xf,  	0x7,    2,	0x7, 0x0120, 16  }, /* PATTERN_KILLER_DQ2*/
   {0xf,  	0x7,    2,	0x7, 0x0140, 16  }, /* PATTERN_KILLER_DQ3*/
   {0xf,  	0x7,    2,	0x7, 0x0160, 16  }, /* PATTERN_KILLER_DQ4*/
   {0xf,  	0x7,    2,	0x7, 0x0180, 16  }, /* PATTERN_KILLER_DQ5*/
   {0xf,  	0x7,    2,	0x7, 0x01a0, 16  }, /* PATTERN_KILLER_DQ6*/
   {0xf,  	0x7,    2,	0x7, 0x01c0, 16  }, /* PATTERN_KILLER_DQ7*/
   {0xf,  	0x7,    2,	0x7, 0x01e0, 16  }, /* PATTERN_KILLER_DQ0_INV*/
   {0xf,  	0x7,    2,	0x7, 0x0200, 16  }, /* PATTERN_KILLER_DQ1_INV*/
   {0xf,  	0x7,    2,	0x7, 0x0220, 16  }, /* PATTERN_KILLER_DQ2_INV*/
   {0xf,  	0x7,    2,	0x7, 0x0240, 16  }, /* PATTERN_KILLER_DQ3_INV*/
   {0xf,  	0x7,    2,	0x7, 0x0260, 16  }, /* PATTERN_KILLER_DQ4_INV*/
   {0xf,  	0x7,    2,	0x7, 0x0280, 16  }, /* PATTERN_KILLER_DQ5_INV*/
   {0xf,  	0x7,    2,	0x7, 0x02a0, 16  }, /* PATTERN_KILLER_DQ6_INV*/
   {0xf,  	0x7,    2,	0x7, 0x02c0, 16  }, /* PATTERN_KILLER_DQ7_INV*/
   {0xf,  	0x7,    2,	0x7, 0x02e0, 16  }, /* PATTERN_VREF*/
   {0xf,  	0x7,    2,	0x7, 0x0300, 16  }, /* PATTERN_VREF_INV*/
   {0xf,  	0x7,    2,	0x7, 0x0320, 16  }, /* PATTERN_FULL_SSO_0T*/
   {0xf,  	0x7,    2,	0x7, 0x0340, 16  }, /* PATTERN_FULL_SSO_1T*/
   {0xf,  	0x7,    2,	0x7, 0x0360, 16  }, /* PATTERN_FULL_SSO_2T*/
   {0xf,  	0x7,    2,	0x7, 0x0380, 16  }, /* PATTERN_FULL_SSO_3T*/
